...
#   if defined( VSSHAREDBUFFER_STATICLIB )
#     #error "Both VSSHAREDBUFFER_MAKINGDLL and VSSHAREDBUFFER_STATICLIB are defined."
#   endif
...
typedef enum
{
  ...
  VSSBR_ERROR_API_VERSION     = -13,  ///< The specified API version is incompatible or unavailable.
...
*/
typedef _declspec(align(8)) struct vssb_FrameInfo_V2
{
  ...
  double    mFovHorizRad;         ///< Horizontal Field of View of the image.
  double    mFovVertRad;          ///< Vertical Field of View of the image.
  ...
  double    mCamOriAngle;         ///< The rotation angle of the axis-angle representation of the camera orientation.
} vssb_FrameInfo_V2;
...
*/
VSSBIMPORTEXPORT const void* __cdecl
