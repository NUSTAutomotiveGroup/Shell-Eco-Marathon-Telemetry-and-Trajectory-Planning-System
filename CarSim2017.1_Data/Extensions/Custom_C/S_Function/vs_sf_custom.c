...
#define S_FUNCTION_NAME vs_sf_custom // This must match the DLL file name
#define S_FUNCTION_LEVEL 2
#include "simstruc.h"

static int sErrorCount = 0, sImportN, sExportN, sIcount;
...
static void mdlInitializeSizes (SimStruct *S)
{
  ...
  if (sErrorCount || vs_get_dll_path (sSimfile, pathDLL))
    {
    ...
    sErrorCount++;
    if (sErrorCount > 1) sErrorCount = 0; // give user another chance
    return;
    }
